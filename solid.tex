  ...
  \begin{center}
    ...
    \begin{minipage}[b]{.7\textwidth}
      \begin{itemize}
        ...
        \item Author of \href{https://staff.cs.utu.fi/~jounsmed/doos_06/material/DesignPrinciplesAndPatterns.pdf}{Design Principles and Design Patterns} paper based on his experience working at Xerox and other companies
      \end{itemize}
