...
\begin{slide}
  ...
  \begin{center}
    ...
    \begin{minipage}[b]{.7\textwidth}
      \begin{itemize}
        \item Renowned software engineer and consultant
        ...
        \item Author of \href{https://web.archive.org/web/20150906155800/http://www.objectmentor.com/resources/articles/Principles_and_Patterns.pdf}{Design Principles and Design Patterns} paper
