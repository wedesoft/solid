...
class Square(Rectangle):
  ...
  def set_height(self, height):
    ...
    \begin{minipage}[c]{.35\textwidth}
      \begin{center}
        \resizebox*{.93\textwidth}{!}{\includegraphics{liskov-depressed}}\\
        Barbara Liskov (sad)
      \end{center}
    \end{minipage}
  \end{center}
...
\begin{slide}
  ...
  \begin{center}
    \textbf{The 5 aspects of the class are:}\footnote{https://swarch.blog/the-five-principles-for-solid-software-design/}\\
...
\begin{slide}
  ...
  \begin{center}
    \textbf{The 5 principles of the class are:}\footnote{https://swarch.blog/the-five-principles-for-solid-software-design/}\\
