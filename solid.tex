...
\begin{slide}
  ...
  \textbf{Me:} What is the motivation for the SOLID software design principles?\\
    \textbf{ChatGPT:} ... Overall, the SOLID principles aim to create software that is easier to \emph{understand}, \emph{extend},
    and \emph{maintain} over time, ultimately leading to higher quality, more \emph{robust} software systems.
\end{slide}
...
\begin{slide}
  ...
  \begin{center}
    The aims of the SOLID principles are:\footnote{Robert C. Martin: Design Principles and Design Patterns}\medskip\\
